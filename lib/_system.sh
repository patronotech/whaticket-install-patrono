...
system_git_clone() {
  print_banner
  printf "${WHITE} 💻 Fazendo download do código ChatPlus...${GRAY_LIGHT}"
  printf "\n\n"
...
system_update() {
  print_banner
  printf "${WHITE} 💻 Vamos atualizar o sistema ChatPlus...${GRAY_LIGHT}"
  printf "\n\n"
...
deletar_tudo() {
  print_banner
  printf "${WHITE} 💻 Vamos deletar o ChatPlus...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_bloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos bloquear o ChatPlus...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_desbloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos Desbloquear o ChatPlus...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_dominio() {
  print_banner
  printf "${WHITE} 💻 Vamos Alterar os Dominios do ChatPlus...${GRAY_LIGHT}"
  printf "\n\n"
...
system_node_install() {
  ...
  sudo su - root <<EOF
  curl -fsSL https://github.com/nvm-sh/nvm | sudo -E bash -
